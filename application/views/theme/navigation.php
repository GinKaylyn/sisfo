                                ...
                                <div class="header_left">
                                    <div class="logo">
                                        <a href="<?php echo base_url('');?>">
                                            <img src="<?php echo base_url('');?>style/img/logoo.png" alt="logo" alt="logo" style="max-width: 150px; max-height: 150px;">
                                        </a>
                                    </div>
                                    <div class="slider_text ">
                                <h1 class="text-top text-black">SEKOLAH ADVENT MAKASSAR </h1>
                                <h2 class="text-top text-black">JL. H.I.A SALEH NO 1.</h2>
                            </div>
                                </div>
